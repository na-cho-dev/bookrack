...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex items-start justify-center px-4 mt-[6.5rem]">
      ...
      <div
        className={`container mx-auto max-w-[1200px] transition-all duration-300 ${
          isDrawerOpen ? "ml-72" : "ml-0"
        }`}
      >
        <div className="py-14 px-6 space-y-8">
          {/* Welcome Header */}
          <div>
